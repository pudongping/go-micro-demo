...
func (c *meetService) Hello(ctx context.Context, in *HelloRequest, opts ...client.CallOption) (*HelloResponse, error) {
...
func (h *meetHandler) Hello(ctx context.Context, in *HelloRequest, out *HelloResponse) error {
